...
pygame.display.set_caption('Ayush Pandey Game')

#define font
font = pygame.font.SysFont('Mignon-Medium', 45)

#define colours
bg = (255, 255, 255)
#block colours
block_yellow = (255, 236, 0)
block_green = (0, 194, 72)
block_blue = (0, 84, 182)
#paddle colours
paddle_col = (158, 3, 174)
paddle_outline = (7, 3, 8)
#text colour
text_col = (78, 81, 139)
